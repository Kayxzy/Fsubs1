...
**Jika Anda memerlukan tambahan module lagi dalam repo atau Jika Anda menemukan bug, silahkan report di group [@AyiinXdSupport](https://www.telegram.dog/AyiinXdSupport)**
...
## Installation
### 𝗗𝗲𝗽𝗹𝗼𝘆 𝗼𝗻 𝗛𝗲𝗿𝗼𝗸𝘂
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Kayxzy/Ayiin-File-Sharing3)
...
## Support   
Bergabunglah di [Group Telegram ](https://www.telegram.dog/AyiinXdSupport) Untuk Dukungan/Bantuan Dan Join [Channel](https://www.telegram.dog/AyiinSupport) untu info Update bot.   
